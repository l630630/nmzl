    ...
    series: [
      {
        ...
        data: [
          ...
          3.65, 7.48, -5.75, 9.02, 3.11, 2.89, 1.22, 6.00, 0.94, 3.66, 5.24, 4.03, 2.98, 1.47, 3.29, -0.03, 0.18, -0.56, 0.90, 0.85, 1.99, 0.54, 0.65, 1.60, 1.20
        ]
      ...
      },
      {
        ...
        data: [
          ...
          4.52637, 4.57058, 4.30695, 4.69470, 4.84022, 4.98042, 5.04139, 5.34343, 5.39409, 5.59113, 5.88493, 6.12226, 6.30482, 6.39648, 6.60603, 6.60435, 6.61607, 6.57892, 6.63843, 6.69492, 6.82848, 6.8653, 6.9541, 7.0650, 7.1488
        ]
      }
    ]
  };
    ...
    series: [
      {
        ...
        data: [96.3, 100.4, 97.8, 115, 114.5, 99.1, 96.5, 103.4, 101.7, 99.8, 103.2, 102.7, 116.5, 110.9, 97.6
        ],
      },
      {
        name: "种植业",
        ...
        data: [98.2, 110.6, 102.8, 100.8, 101.2, 99.5, 97, 99.2, 101.8, 104.3, 104.8, 107.8, 116.6, 102.9, 108.4],
      },
      {
        name: "畜牧业",
        type: "bar",
        ...
        data: [95.4, 82.1, 132.4, 133.5, 95.6, 90.8, 110.4, 104.2, 97.1, 102.4, 99.7, 126.2, 103, 90.1, 123.9],
      },
      {
        name: "海水养殖",
        type: "bar",
        ...
        data: [102.3, 105.6, 96.3, 97.2, 101.4, 107.9, 104.1, 101, 101.9, 100.7, 101, 111.5, 107.6, 99, 111.2],
      },
    ],
  };
...
(function () {
  ...
  var data = [
    // 2025年（万公顷，基于趋势估算）
    [17380.0, 11620.0, 7580.0, 7560.0, 7120.0, 6510.0, 6080.0, 5600.0, 5440.0, 5280.0],
    // 2024年（实际数据）
    [17195.40, 11496.50, 7514.10, 7498.50, 7038.60, 6461.90, 6034.20, 5546.90, 5395.50, 5227.20],
    // 2023年
    [16980.20, 11320.60, 7480.30, 7420.10, 6890.40, 6380.50, 5960.80, 5490.30, 5310.60, 5180.40],
  ];
  ...
  option = {
    ...
    series: [

      {
        ...
        data: [
          20259, 19280, 17734, 18434, 16046, 15382, 13985, 12145, 10609, 9409, 8365, 7397, 6573, 5880, 4782
        ],
      },
      {
        name: "城镇居民消费水平(元)",
        ...
        data: [
          35869, 34557, 32082, 37995, 34043, 34900, 32483, 30323, 28154, 26119, 24430, 22620, 20869, 19218, 16570
        ],
      },
      {
        name: "居民消费水平(元)",
        ...
        data: [
          29476, 28227, 26796, 31013, 27439, 27504, 25245, 22968, 20801, 18857, 17220, 15586, 14074, 12668, 10575
        ],
      },
    ],
  };
    ...
    series: [
      {
        ...
        data: [
          56.20, 53.81, 46.79, 33.95, 34.21, 37.90, 30.10, 31.32, 26.94, 24.16, 25.01, 21.27, 23.52, 22.05, 21.27],
      },

      {
        ...
        data: [
          22.50, 21.83, 20.55, 22.46, 18.16, 16.70, 15.22, 15.34, 16.05, 15.88, 16.70, 17.57, 17.71, 14.37, 15.02],
      },
      {
        name: "村卫生室个数",
        type: "line",
        ...
        data: [
          57.10, 57.10, 59.60, 75.64, 67.34, 56.41, 52.37, 54.60, 45.32, 46.66, 42.99, 40.04, 41.71, 38.84, 41.23],
      },
    ],
  };
    ...
    series: [
      {
        ...
        data: [
          39000, 40000, 40000, 40000, 38000, 34000, 30000, 29000, 28000, 27752, 33043, 32475, 34304, 32828, 29904
        ],
      },
      {
        name: "儿童福利机构单位数(个)",
        ...
        data: [
          41960, 43000, 42534, 40852, 37021, 31291, 31929, 31912, 31187, 36810, 35977, 38078, 35973, 34482, 23944
        ],
      },
    ],
  };
...
(function () {
  ...
  //农民工规模(万人)
  var lineData = [
    26894, 27395, 27747, 28171, 28652, 28836, 29077, 28560, 29251, 29562, 29753, 29973, 30115,
  ];
  //外出农民工规模(万人)
  var barData = [
    16610, 16821, 16884, 16934, 17185, 17266, 17425, 16959, 17172, 17190, 17658, 17871, 18006,
  ];
  //本地农民工规模(万人)
  var cData = [
    10284, 10574, 10863, 11237, 11467, 11570, 11652, 11601, 12079, 12372, 12095, 12102, 12109,
  ];
  //跨省流动农民工规模(万人)
  var dData = [
    7739, 7867, 7745, 7666, 7675, 7594, 7508, 7052, 7130, 7061, 7522, 6840, 6920,
  ];
  //农民工月均收入(元)
  var rateData = [
    2609, 2864, 3072, 3275, 3485, 3721, 3962, 4072, 4432, 4615, 4780, 4961, 5075,
  ];
    ...
    xAxis: [
      {
        type: 'category',
        boundaryGap: false,
        data: ['2025', '2024', '2023', '2022', '2021', '2020', '2019', '2018', '2017', '2016', '2015', '2014', '2013', '2012']
      }
    ],
    yAxis: [
      {
    ...
    series: [
      {
        ...
        data: [72504, 73439, 74041, 74652, 75064, 75447, 75782, 76058, 76245, 76320, 76349, 76301, 76254, 76704]
      },
      {
        type: "value",
        scale: true,
        ...
        areaStyle: {},
        emphasis: { focus: 'series' },
        data: [47535, 47345, 46837, 46773, 46271, 45249, 44292, 43208, 42051, 40916, 39703, 38527, 37287, 35914]
      },
      {
        type: "value",
        scale: true,
        ...
        areaStyle: {},
        emphasis: { focus: 'series' },
        data: [24969, 26094, 27204, 27879, 28793, 30198, 31490, 32850, 34194, 35404, 36646, 37774, 38967, 40790]
      }
    ]
  };
  // 使用刚指定的配置项和数据显示图表。
